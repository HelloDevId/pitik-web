...
@section('title', 'Data Catat Ayam')

@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Data Catat Ayam</h2>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/datacatatayam/{{ $data->id }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                        ...
                                                        <form action="/datacatatayam/{{ $data->id }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="example-select">Id Ayam</label>
                                                                    <select class="form-control" name="id_ayam"
                                                                        id="example-select">
                                                                        <option value="{{ $data->id_ayam }}">
                                                                            {{ $data->id_ayam }}
                                                                        </option>
                                                                        @foreach ($id_ayam as $item)
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/datacatatayam" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="example-select">Id Ayam</label>
                                                        <select class="form-control" name="id_ayam" id="example-select">
                                                            <option value="">Pilih Id Ayam</option>
                                                            @foreach ($id_ayam as $item)
                                                                <option value="{{ $item->id }}">
                                                                    {{ $item->id }}</option>
                                                            @endforeach
