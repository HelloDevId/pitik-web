...
@section('title', 'Data Sample Jual')

@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Data Sample Jual</h2>
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        @php
                                            $no = 1;
                                        @endphp
                                        @foreach ($samplejual as $data)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $data->userdetail->user_fullname }}</td>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/datasamplejual/{{ $data->id }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                        ...
                                                        <form action="/datasamplejual/{{ $data->id }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="simple-select2">Id User</label>
                                                                    <select disabled class="form-control select2"
                                                                        id="simple-select2">
                                                                        <option value="{{ $data->id_user }}">
                                                                            {{ $data->userdetail->user_fullname }}
                                                                        </option>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="recipient-name"
                                                                        class="col-form-label">Sample Jual
                                                                    </label>
                                                                    <input type="text" value="{{ $data->jumlah_jual }}"
                                                                        name="jumlah_jual" class="form-control"
                                                                        id="recipient-name">
                                                                </div>
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/datasamplejual" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
                                                        ...
                                                        <select name="id_user" class="form-control select2"
                                                            ...
                                                            @foreach ($datauser as $item)
                                                                ...
                                                                <option value="{{ $item->id }}">
                                                                    {{ $item->user_fullname }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="recipient-name" class="col-form-label">Sample Jual
                                                        </label>
                                                        <input type="text" value="" name="jumlah_jual"
